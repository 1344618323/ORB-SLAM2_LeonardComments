...
void Frame::ComputeStereoMatches()
{
    ...
    //(cxn) ur=ul-fx*b/d
    // 这里的意思是 匹配出来的点 最小深度 minZ 必须大于 b， 此时视差是必须大于 fx 的
    // maxD=fx*b/b=fx 最大视差为fx，此时有 fx*b/d<fx 对应的正是 d>b
    // 对最小视差 minD=0，也就是说 对匹配出来的点的最大深度是没有要求的
    // 但是阴差阳错，mb此时还未赋值，也就是说视差可以无限大了，所以这里确实是一个bug
